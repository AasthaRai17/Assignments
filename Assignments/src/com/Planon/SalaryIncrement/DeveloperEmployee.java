...
public class DeveloperEmployee implements Employee {
	...
	public DeveloperEmployee(String empName, double empSalary) {
		
		this.empDept = constants.DEVELOPER;
	...
	public void setIncSalary() {
		this.newEmpSalary = Employee.increaseSalary(empSalary, constants.DEV_SAL_INC);
