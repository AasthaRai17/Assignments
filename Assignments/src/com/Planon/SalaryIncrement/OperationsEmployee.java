...
public class OperationsEmployee implements Employee {
	...
	public OperationsEmployee(String empName, double empSalary) {
		
		this.empDept = constants.OPERATIONS;
	...
	public void setIncSalary() {
		this.newEmpSalary = Employee.increaseSalary(empSalary, constants.OPER_SAL_INC);
